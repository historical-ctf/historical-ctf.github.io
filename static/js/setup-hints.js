...
var hints = [
  ...
  'Try <a href="scripts/dictionary.txt">this</a> list of common passwords.',
  'Click <a href="scripts/solution.py">here</a> for a reference solution, which relies on <a href="scripts/dictionary.txt">this list of common passwords</a>. Run it to crack Badguy\'s password! Don\'t expect everything in life to be this easy.'
];
